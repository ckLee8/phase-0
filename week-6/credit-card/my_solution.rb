...
#We had difficulty with data type conversion. We often got the error coerce array to fixnum.
#What new methods did you find to help you when you refactored?
#I don't think we utilized any new methods. We simple cleaned up the code.
#What concepts or learnings were you able to solidify in this challenge?
#I think just re-enforcing that different data types behave differently, which is often both a feature and obstacle when coding. 